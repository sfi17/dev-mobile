...
const parkingsSpots = [
  {
    ...
    description: `Parking clandestin
    ...
    return (
      <View style={styles.header}>
        <View style={{ flex: 1, justifyContent: 'center' }}>
          <Text style={styles.headerTitle}>Votre location </Text>
          <Text style={styles.headerLocation}>Antananarivo, Madagascar</Text>
        </View>
          ...
          <View style={styles.parkingInfoContainer}>
            <View style={styles.parkingInfo}>
              <View style={styles.parkingIcon}>
                ...
                <Text style={{ marginLeft: theme.SIZES.base }}> {item.price}Ar</Text>
              </View>
              <View style={styles.parkingIcon}>
        ...
        <View style={styles.modal}>
          ...
          <View style={styles.modalInfo}>
            <View style={[styles.parkingIcon, {justifyContent: 'flex-start'} ]}>
              ...
              <Text style={{ fontSize: theme.SIZES.icon * 1.15 }}> {activeModal.price} Ar</Text>
            </View>
            <View style={[styles.parkingIcon, {justifyContent: 'flex-start'} ]}>
          ...
          <View style={styles.modalHours}>
            <Text style={{ textAlign: 'center', fontWeight: '500' }}>Choisissez la durree</Text>
          ...
          <View>
            <TouchableOpacity style={styles.payBtn}>
              <Text style={styles.payText}>
                Payer {activeModal.price * hours[activeModal.id]} Ar
              </Text>
              <FontAwesome name='angle-right' size={theme.SIZES.icon * 1.75} color={theme.COLORS.white} />
            </TouchableOpacity>
          </View>
